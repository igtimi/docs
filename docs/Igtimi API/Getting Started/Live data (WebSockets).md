...
Igtimi may provide more than one different WebSocket servers at any time.  Use the SERVER_LISTERS API call to determine which server(s) are available to connect to. Here’s the cURL example…
