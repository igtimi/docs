...
1. Add competitor boats to your race session.\
...
1. Add race marks to your race session.\
...
1. Save and close the Race Editor.\
...
1. Determine your race start type.\
...
1. Attach the lap line to each of the 'lap' / 'leg' columns.\
